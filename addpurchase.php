...
if(isset($_POST['purchasedate']))
{
    ...
    query('purchases');
    $query="Select purchaseid from purchases order by purchaseid desc limit 1";
          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="box box-primary">
                      <form class="myform" action="addpurchase.php" method="post">
                          <div class="box-body">
                          <div class="row">
                              ...
                              <div class="col-md-3">
                                  <div class="form-group">
                                      ...
                                      $result=  queryMysql($query);
                                      $row=mysqli_fetch_array($result);
                                      $purchaseid=id($row['purchaseid']+1);
                                      $purchaseid="PU-".$purchaseid;
                                      echo <<<_END
                                      <input type="text" value="$purchaseid" class="form-control" placeholder="Item Id"/>
_END;
                                      ?>
                                  </div>
                              </div>
                              <div class="col-md-3 col-md-offset-6">
                                ...
                                <div class="input-group">
                                  <div class="input-group-addon">
                                   ...
                                   echo<<<_END
                                  <input tabindex="0" type="text" name="purchasedate"  value="$date" class="form-control mandatory focus" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
_END;
                                   ?>
                                </div><!-- /.input group -->
                              </div>
...
<!--                                          <a href="#">
                    ...
                    Add More Items</a>-->
                              ...
                              <div class="row">
                                  <div class="box-body">
                                      <div class="col-md-2">
                                          <button class="btn btn-block btn-primary submit">Save Purchase</button>
                                      </div>
                                      <div class="col-md-2">
