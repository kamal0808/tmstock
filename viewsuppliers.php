...
?>
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            View/Edit Suppliers
            <small>View and Edit Supplier details</small>
          </h1>
          <ol class="breadcrumb">
            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="box box-primary">
                      ...
                      <div class="box-body">
                          <div class="row">
                              <form class="myform" action="viewsuppliers.php" method="GET">
                              <div class="col-md-4">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                         ...
                         {
                             $city=$_GET['city'];
                            $query="Select * from suppliers where city='$city'";
                         }
                         else
                         {
                        ...
                        while($row=  mysqli_fetch_array($result))
                        {
                            ...
                            <tr>
                                ...
                                <td>$row[name]</td>
                                <td>$row[city]</td>
                                <td><a href="supplier.php?supplierid=$row[supplierid]&func=view">View Details</a></td>
